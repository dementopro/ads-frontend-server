...
const BoostUseCase = ({ useCase }: Props) => {
  return (
    <div className='relative w-full overflow-hidden'>
      ...
      <div className="desktop:w-[1240px] ipad:w-full desktop:mx-auto android:p-[32px] ipad:p-[60px] desktop:p-[0px] android:my-[32px] ipad:my-[0px] desktop:my-[60px] bg-black relative overflow-hidden">
        <div className='w-full ipad:mx-auto android:mx-0 flex android:flex-col desktop:flex-row gap-[32px] justify-center items-center z-20'>
          <div className="relative android:w-full desktop:w-2/5 text-white font-poppins font-semibold android:text-center desktop:text-left android:text-[34px] ipad:text-[43px] android:leading-[34px] ipad:leading-[43px] ipad:tracking-[-3px]">
            Boost Your <br />
            <span className="relative bg-brand-color text-transparent bg-clip-text">
              <Image
                ...
                alt='decor'
              />
              {useCase.boostUp.colorHead}
            </span>
          </div>
          <div className='android:w-full desktop:w-3/5 relative'>
            <div className='w-full relative z-20 flex flex-col gap-[32px] items-start justify-start'>
              {useCase.boostUp.details.map((item, index) =>
                <div key={index} className={`w-full flex flex-col gap-[16px] pl-[16px] border-l-4 ${item.color == '#7879F1' ? 'border-[#7879F1]' : 'border-[#EF5DA8]'}`}>
                  <div className={`font-poppins font-semibold android:text-[34px] ipad:text-[43px] ${item.color == '#7879F1' ? 'text-[#7879F1]' : 'text-[#EF5DA8]'}`}>
                    {item.title}
                  </div>
