...
const Step5 = () => {
  return (
    <div className="desktop:w-[1240px] ipad:w-full desktop:mx-auto android:p-[32px] ipad:p-[60px] desktop:p-[0px] android:my-[16px] ipad:my-[32px] bg-black android:flex-col ipad:flex-row justify-center items-center gap-[32px] inline-flex">
      <Image
        width={696}
        height={529}
        className="android:hidden ipad:block android:w-full ipad:w-2/5 h-auto object-cover"
        src='/images/features/step5.svg'
        alt="step5"
      />
