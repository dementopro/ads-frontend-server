...
const IntroTwo = () => {
  return (
    <div className='w-full max-sm:p-4 max-sm:flex-col px-20 my-2 sm:my-10 flex flex-row-reverse items-center justify-between'>
      <div className='flex flex-col gap-8'>
        <div className='text-3xl max-sm:text-center max-w-[500px]'>
          No code interface & low maintenance for users applications
        </div>
        <div className='text-primary-gray max-sm:text-center flex flex-col gap-4 max-w-[580px] text-sm'>
      ...
      <div className='relative max-sm:w-[90%] max-sm:mt-8 w-[580px] sm:h-[500px] h-[400px]'>
