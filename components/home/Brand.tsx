      ...
      <div className="mt-4">
        <div className="max-w-[986px] mx-auto rounded-lg bg-[#010314] grid grid-cols-12 p-1">
          {tabs.map((val, i) => (
            <button
              key={i}
              className={`transition-all col-span-3 bg-transparent rounded-md text-[#838383] flex items-center justify-center px-[10px] py-3 ${
                tab === val.value && '!bg-[#7D55FA] text-white'
              }`}
          ...
          tabs.map((val, i) => ( val.value === tab &&
            (<Fragment key={i}>
              ...
              <div className="relative top-0 left-0 grid grid-cols-12 gap-4 px-4 overflow-visible">
                <div className="relative android:col-span-12 ipadmini:col-span-6 ipad:col-span-6 desktop:col-span-6">
                  <div
                    className="absolute top-0 left-0 z-0 h-full ipadmini:w-full ipad:w-full desktop:col-span-6 translate-y-[10%]"
                    style={{
                      background:
                ...
                <div  className="bg-center bg-no-repeat bg-contain android:col-span-12 ipadmini:col-span-6 ipad:col-span-6 desktop:col-span-6 android:h-[300px] ipadmini:h-[300px] ipad:h-[350px] desktop:h-[350px]"
