...
const Banner = () => {
    ...
    return (
        <>
            <div className="w-full ipad:h-[73px] desktop:h-[73px] left-0 top-[-50px] font-poppins absolute bg-gradient-to-r from-indigo-500 to-purple-500 rounded-tl-[25px] rounded-tr-[25px] shadow z-neg-1">
