  ...
  return (
    <div className="w-full h-auto relative">
      ...
      <div className="ipad:px-[60px] desktop:px-[100px] android:pt-[0px] ipadmini:pt-[0px] ipad:pt-[82px] desktop:pt-[82px] pb-[32px] w-full relative z-10 bg-hero-pattern bg-cover">
        <Header />
        <div className="ipad:w-full desktop:w-full h-full android:mt-[16px] ipad:mt-[48px] justify-start items-center flex android:flex-col ipadmini:flex-col ipad:flex-row desktop:flex-row android:gap-[32px] ipadmini:gap-[32px] ipad:gap-[20px] desktop:gap-[32px]">
          <div className="android:px-[16px] ipadmini:px-[32px] android:pt-[32px] ipadmini:pt-[16px] android:w-full ipadmini:w-full ipad:w-full desktop:w-7/12 flex-col android:justify-center ipadmini:justify-center ipad:justify-start desktop:justify-start android:items-center ipadmini:items-center ipad:items-start desktop:items-start android:gap-[12px] ipadmini:gap-[14px] ipad:gap-[16px] desktop:gap-[16px] inline-flex">
          ...
          <div className="android:px-[16px] ipadmini:px-[32px] ipad:w-full desktop:w-6/12 font-Poppins flex-row android:gap-[16px] ipadmini:gap-[16px] ipad:gap-[0px] desktop:gap-[10px] inline-flex">
