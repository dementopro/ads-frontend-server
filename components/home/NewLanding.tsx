  ...
  return (
    <div className="w-full h-auto relative">
      ...
      <div className="ipad:px-[60px] desktop:px-[100px] android:pt-[0px] ipadmini:pt-[0px] ipad:pt-[82px] desktop:pt-[82px] pb-[32px] w-full relative z-10 bg-hero-pattern bg-cover">
        <Header />
        <div className="ipad:w-full desktop:w-full h-full justify-start items-center flex android:flex-col ipadmini:flex-col ipad:flex-row desktop:flex-row android:gap-[32px] ipadmini:gap-[32px] ipad:gap-[20px] desktop:gap-[32px]">
