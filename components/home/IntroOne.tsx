...
const IntroOne = () => {
  return (
    <div className='w-full max-sm:p-4 max-sm:flex-col px-20 my-2 sm:my-10 flex items-center justify-between'>
      <div className='flex flex-col gap-8 max-sm:mb-6'>
        <div className='text-3xl max-sm:text-center max-w-[500px]'>One click deployment to public or on-premise cloud</div>
