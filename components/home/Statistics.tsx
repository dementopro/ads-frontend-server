...
const Statistics = () => {
    ...
    return (
        <div className='desktop:w-[1240px] ipad:w-full desktop:m-auto ipad:m-[0px] android:my-[32px] ipad:my-[60px] bg-black flex-col justify-center items-center gap-10 inline-flex'>
