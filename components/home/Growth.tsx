  ...
  return (
    <div className='w-full android:my-[32px] ipad:my-[60px] bg-black'>
      <div className="w-full flex-col justify-center items-center android:gap-[30px] ipadmini:gap-[40px] ipad:gap-[50px] desktop:gap-[60px] inline-flex">
        <div className="w-full text-center text-white android:text-[20px] ipadmini:text-[20px] ipad:text-[20px] desktop:text-[24px] font-poppins leading-normal bg-clip-text text-transparent bg-gradient-radial from-white to-white/50">
