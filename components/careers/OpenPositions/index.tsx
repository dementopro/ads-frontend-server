                ...
                <div key={index} className="w-full flex flex-col gap-[32px] z-20">
                    ...
                    <div className="flex flex-col gap-[32px]">
                        {item.positions.map((position, index) => (
                            <div key={index} className="android:w-full desktop:w-3/4 flex flex-row items-center bg-[#27252D] android:rounded-[8px] ipad:rounded-[12px] android:px-[16px] ipad:px-[32px] android:py-[45px] ipad:py-[48px]">
