      ...
      <div className="relative flex flex-col w-full h-auto">
        <div className="ipad:px-[60px] desktop:px-[100px] android:pt-[0px] ipad:pt-[82px] w-full relative bg-hero-pattern bg-cover">
          ...
          <div className="ipad:w-[900px] flex flex-col gap-[32px] justify-center items-center relative android:mx-[32px] ipad:mx-auto mt-[32px]">
            <Link
              href={`/blog`}
              className="w-full flex flex-row gap-[8px] mt-[32px] text-white hover:text-violet-500 items-center android:text-[12px] ipad:text-[16px] relative text-left border-b-1 border-[#A09BAE] transition ease-in-out !duration-500">
              <FiArrowLeft
            ...
            <div className="w-full android:h-[180px] ipadmini:h-[380px] desktop:h-[260px]">
              <img src={blog.introductionImage} className="w-full h-full object-cover android:rounded-[8px] ipad:rounded-[12px]" />
            </div>
