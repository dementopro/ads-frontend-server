    ...
    <DefaultLayout>
      ...
      <div className="w-full h-auto relative">
        <div className="ipad:px-[60px] desktop:px-[100px] android:pt-[0px] ipad:pt-[82px] android:pb-[32px] ipad:pb-[60px] w-full relative z-10 bg-hero-pattern bg-cover">
          <Header />
          <div className="android:mx-[32px] android:my-[32px] ipad:mx-[60px] ipad:my-[60px]">
            <div className="text-white font-Poppins font-bold android:text-center ipad:text-left android:text-[34px] ipadmini:text-[44px] ipad:text-[54px] desktop:text-[64px]">
              Privacy & Terms
            </div>
            <div className="text-[#D0D0D0] font-Open+Sans font-regular android:text-center ipad:text-left android:text-[12px] ipadmini:text-[16px] ipad:text-[20px] desktop:text-[24px]">
              Last updated: April 2023
            </div>
          </div>
        </div>

        <div className="flex flex-col android:m-[32px] android:mb-[32px] ipad:mx-[60px] ipad:mb-[60px] android:gap-[16px] ipad:gap-[32px]">
