...
// Define the ButtonProps interface for button properties
type ButtonProps = {
  isActive: boolean;
  onClick: () => void;
  text: string;
...
// Define the Props interface for Aspect component
type Props = {
  ...
  return (
    <>
      <div className='flex items-center gap-3'>
        ...
        {/* Render buttons for different aspect ratios */}
