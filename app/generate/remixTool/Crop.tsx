...
// import WatermarkImage from '@/app/generate/remixTool/WatermarkImage'
          ...
          !!imgSrc && (
            <div className='flex flex-col items-center gap-3 mt-4'>
              <div className='relative flex w-min hover:opacity-80'>
                ...
                <input type='file' accept='image/*' className='absolute top-0 left-0 right-0 bottom-0 w-full h-full z-2 opacity-0 cursor-pointer' onChange={onSelectFile} />
              </div>
              <button
