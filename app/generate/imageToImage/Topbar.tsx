  ...
  return (
    <div className='flex flex-wrap gap-2 justify-between items-center mb-4'>
      ...
      <div className='flex items-center justify-between border border-[#35363A] bg-[#1B1C21] p-[6px] rounded-lg'>
        <button onClick={() => updateModeType('portrait')} className={`py-1 px-4 flex items-center justify-between border gap-2 rounded-lg transition ease-in-out ${modeType === 'portrait' ? 'bg-[#35363A] border-primary-purple' : 'border-transparent'}`}>
        ...
        <button onClick={() => updateModeType('product')} className={`py-1 px-4 flex items-center justify-between border gap-2 rounded-lg transition ease-in-out ${modeType === 'product' ? 'bg-[#35363A] border-primary-purple' : 'border-transparent'}`}>
